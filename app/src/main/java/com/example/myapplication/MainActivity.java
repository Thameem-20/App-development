...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_3=(Button)findViewById(R.id.button14);
        btn_4=(Button)findViewById(R.id.button14);
        btn_5=(Button)findViewById(R.id.button14);
        btn_6=(Button)findViewById(R.id.button14);
